...
public class AirIntakeInstance extends KineticBlockEntityInstance<com.drmangotea.tfmg.blocks.engines.intake.AirIntakeBlockEntity> implements DynamicInstance {
    ...
    public AirIntakeInstance(MaterialManager materialManager, com.drmangotea.tfmg.blocks.engines.intake.AirIntakeBlockEntity blockEntity) {
