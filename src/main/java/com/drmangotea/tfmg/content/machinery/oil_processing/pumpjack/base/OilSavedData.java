...
public class OilSavedData extends SavedData {
    ...
    public CompoundTag save(CompoundTag compound, HolderLookup.Provider provider) {
        OilDataManager manager = TFMG.DEPOSITS;
    ...
    public List<FluidReservoir> getReservoirs() {
        return list;
    }


    public static OilSavedData load(CompoundTag compound, HolderLookup.Provider registries) {
        OilSavedData sd = new OilSavedData();
    ...
    public static SavedData.Factory<OilSavedData> factory() {
        return new SavedData.Factory<>(OilSavedData::new, OilSavedData::load);
    }

    public static OilSavedData load(MinecraftServer server) {
