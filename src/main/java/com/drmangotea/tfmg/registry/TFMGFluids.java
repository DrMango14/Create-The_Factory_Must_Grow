...
import com.drmangotea.tfmg.blocks.concrete.asphalt.AsphaltFluid;
...
public class TFMGFluids {
    ...
    //public static final FluidEntry<ForgeFlowingFluid.Flowing> SKIBIDI_TOILET_WATER =
    //        REGISTRATE.fluid("skibidi_toilet_water",
    //                        CRUDE_OIL_STILL_RL,
    //                        CRUDE_OIL_FLOW_RL,ConcreteFluidType.create(0xEAAE2F,
    //                        () -> 1f / 8f * AllConfigs.client().honeyTransparencyMultiplier.getF()))
    //                .lang("Skibidi Toilet Water")
    ...
    public static final FluidEntry<ForgeFlowingFluid.Flowing> CREOSOTE =
            REGISTRATE.standardFluid("creosote")
                    .lang("Creosote")
                    .properties(b -> b.viscosity(1000)
                            .density(1000))
                    .fluidProperties(p -> p.levelDecreasePerBlock(1)
